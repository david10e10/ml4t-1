...
class KNNLearner(object):
    ...
    def query(self, Xtest):
        ...
        #TODO, reshape so it automatically gets in right dimensional space, but getting lazy now
...
# ValueError: operands could not be broadcast together with shapes (192,288) (192,288,1)

        # ValueError: operands could not be broadcast together with shapes (192,288) (192,1,480)
